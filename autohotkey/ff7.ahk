...
Joy1Button = a  ; Select                    / Button: A
Joy2Button = b  ; Cancel                    / Button: B
Joy3Button = x  ; Card Game                 / Button: X
Joy4Button = y  ; Menu                      / Button: Y
Joy5Button = 1  ; Escape (left)             / Button: LB
Joy6Button = 2  ; Escape/Switch POV (right) / Button: RB
Joy7Button = k  ; Toggle Display (Map)      / Button: Back/Select
Joy8Button = s  ; Pause                     / Button: Start
Joy9Button = l  ; Rotate Left               / Button: Left Thumbstick
Joy10Button = r ; Rotate Right/Trigger      / Button: Right Thumbstick
