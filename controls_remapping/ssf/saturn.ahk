...
Run, SSF.exe, E:\entertainment\software\SSF_012_beta_R4\

; -Button Assignments-
; (if you want a button to not do anything, leave it blank)
Joy1Button = z  ;                   / Button: A
Joy2Button = x  ;                   / Button: B
Joy3Button = s  ;                   / Button: X
Joy4Button = d  ;                   / Button: Y
Joy5Button = a  ;                   / Button: LB
Joy6Button = g  ;                   / Button: RB
Joy7Button = k  ;                   / Button: Back/Select
Joy8Button = Enter  ;               / Button: Start
Joy9Button = l  ;                   / Button: Left Thumbstick
Joy10Button = r ;                   / Button: Right Thumbstick

; -Trigger Assignments-
LTrigger = f   ; Speed Boost (I prefer having Speed Boost here for handiness, but l for Rotate Left {h default} may be desired instead)
RTrigger = c    ; Rotate Right/Trigger
